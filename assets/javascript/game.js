...
var characters = {
    'beetlejuice': {
        ...
        hp: 120,
        attack: 8,
        imageUrl: "assets/images/beetlejuice.jpeg",
        enemyAttackBack: 15
    }, 
    'lydia deetz': {
        name: 'lydia deetz',
        hp: 100,
        attack: 14,
        imageUrl: "assets/images/lydiadeetz.jpg",
        enemyAttackBack: 5
    }, 
    'barbara and adam': {
        name: 'barbara and adam',
        hp: 150,
        attack: 8,
        imageUrl: "assets/images/barbara-adam.jpg",
        enemyAttackBack: 20
    }, 
    'receptionist': {
        name: 'receptionist',
        hp: 180,
        attack: 7,
        imageUrl: "assets/images/receptionist.jpg",
        enemyAttackBack: 20
    }
};
...
var renderOne = function(character, renderArea, makeChar) {
  ...
  $("#attack-button").on("click", function() {
    ...
    if ($('#defender').children().length !== 0) {
      ...
      renderMessage("clearMessage");
      //combat
      currDefender.hp = currDefender.hp - (currSelectedCharacter.attack * turnCounter);
      ...
      if (currDefender.hp > 0) {
        ...
        currSelectedCharacter.hp = currSelectedCharacter.hp - currDefender.enemyAttackBack;
